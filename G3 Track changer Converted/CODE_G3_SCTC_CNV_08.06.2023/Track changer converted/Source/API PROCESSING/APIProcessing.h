...
#define MAX_UART_TX_BUFFER_LENGTH               1500
#define MAX_UART_RX_BUFFER_LENGTH               500
#define MAX_ACK_TX_BUFFER_LENGTH                200

#define MAX_NO_OF_VALUES MAX_NO_OF_TRACKS+2+1
...
#if (MAX_NO_OF_SET_DATA>MAX_NO_OF_TRACKS)
#error ("MAX_NO_OF_SET_DATA should be less than MAX_NO_OF_TRACKS");
#endif

#define JSON_NO_OF_MODE_STATE_DATA              1+1 //+1 is CRC
#define JSON_NO_OF_DIR_STATE_DATA              2+1 //+1 is CRC
#define JSON_NO_OF_PWM_DATA_MOTOR               7+1
#define JSON_NO_OF_PWM_DATA_BRUSH               3+1
//#define JSON_NO_OF_RTC_DATA                     1+1
...
#define JSON_NO_OF_TRACK_INFO_DATA              MAX_NO_OF_SET_DATA+2+1
...
static eJsonStatus ProcessSetCommDistance (const char * jsonString);
