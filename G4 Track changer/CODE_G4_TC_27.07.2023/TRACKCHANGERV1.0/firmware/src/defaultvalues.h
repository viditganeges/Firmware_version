...
//#define DEFAULT_DEVICE_WELCOME_MSG  "Solarcleaner_V1.0"
...
#define DEVICE_FIRMWARE_VERSION                            "FV:4.0.3"                
#define HEX_VERSION                                        " H1.0"  
#define DEFAULT_DEV_ID                                     "FFFFF"
#define DEFAULT_DEV_HW_REV                                 "HV:4.0 " //"1.1V"   //should be changed according to HARDWARE_VERSION
#define DEFAULT_DEV_SW_REV                                 DEVICE_FIRMWARE_VERSION
#define DEFAULT_DEV_SERIAL_NO                              "TC000" //"SL000"

#define DEFAULT_DEVICE_WELCOME_MSG_HEADER                  "TRACK CHANGER "
#define DEFAULT_DEVICE_WELCOME_MSG_FOOTER                  " **"
  
#define DEFAULT_DEVICE_WELCOME_MSG                         DEFAULT_DEVICE_WELCOME_MSG_HEADER DEFAULT_DEV_HW_REV DEFAULT_DEV_SW_REV//DEVICE_FIRMWARE_VERSION HEX_VERSION//DEFAULT_DEVICE_WELCOME_MSG_FOOTER
