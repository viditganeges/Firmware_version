...
//#define COUNTSENSOR  ROTATESENSOR_1          // ROTATESENSOR_2      //changed
...
#define ROTATESENSE1_NOISE_TIME_MS             10    /* Minimum Time For the Signal to be constant for it to be considered as Valid */
#define ROTATESENSE2_NOISE_TIME_MS             10    /* Minimum Time For the Signal to be constant for it to be considered as Valid */
...
void Rotate_Sense1_Irq(void)
{
    ...
    {
      RotateSense1TimerOn(ROTATESENSE1_NOISE_TIME_MS);
    }
    else
    {
...
void Rotate_Sense2_Irq(void)
{
    ...
    {
      RotateSense2TimerOn(ROTATESENSE2_NOISE_TIME_MS);
    }
    else
    {
...
void StartRotateSense2Count (void)
{
  ...
  {
  rotateCount2 = GetPrevRotateSense2Count();
  }
//  GPIO_PortClearInterruptFlags(ROTATE_SENSE2_GPIO, 1U << ROTATE_SENSE2_GPIO_PIN);
