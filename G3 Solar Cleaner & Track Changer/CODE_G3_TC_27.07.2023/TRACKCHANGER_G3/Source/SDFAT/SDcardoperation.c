...
void SOC_log_Data(char *Log_dataas)
{
    ...
    ParseHeaderData(&txBuff[dataCount1],&bufferLength,CMD_SOC_LOG); //301C
...
//    uint8_t tempCount = snprintf(&Log_Array[dataCount],100,"%s,%s,%s,%s,%s,%s,%d",Vin_str,Iin_str,Vbat_str, Ibat_str,Dtemp_str,Soc_Str,GetChargingOrNot()); 
...
void cleaner_log_Data(char *Log_dataas)
{
    ...
    txBuff[dataCount1]=0;
    uint16_t bufferLength = sizeof(txBuff)-dataCount1;
    ParseHeaderData(&txBuff[dataCount1],&bufferLength,CMD_CLEANER_LOG); //300E
    dataCount1 = dataCount1+bufferLength;
    bufferLength = sizeof(txBuff)-dataCount1;  
...
void ERROR_log_Data(char *Log_dataas)
{
    ...
    txBuff[dataCount1]=0;
    uint16_t bufferLength = sizeof(txBuff)-dataCount1;
    ParseHeaderData(&txBuff[dataCount1],&bufferLength,CMD_ERROR_LOG); //3018
    dataCount1 = dataCount1+bufferLength;
    bufferLength = sizeof(txBuff)-dataCount1;  
...
void AutoCycle_log_Data(char *Log_dataas)
{
    ...
    txBuff[dataCount1]=0;
    uint16_t bufferLength = sizeof(txBuff)-dataCount1;
    ParseHeaderData(&txBuff[dataCount1],&bufferLength,CMD_AUTO_CYCLE_LOG); //300F
    dataCount1 = dataCount1+bufferLength;
    bufferLength = sizeof(txBuff)-dataCount1;  
