...
#define SENSE2_NOISE_TIME_MS             1    /* Minimum Time For the Signal to be constant for it to be considered as Valid */
...
bool RotateSense2Init (void)
{
  ...
  PORT_SetPinMux(ROTATE_SENSE2_PORT, ROTATE_SENSE2_GPIO_PIN, kPORT_MuxAsGpio);
...
DisableInterrupt();
PORT_SetPinMux(ROTATE_SENSE2_PORT, ROTATE_SENSE2_GPIO_PIN, kPORT_PinDisabledOrAnalog);
}