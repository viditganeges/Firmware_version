...
#define SENSE1_NOISE_TIME_MS             1    /* Minimum Time For the Signal to be constant for it to be considered as Valid */
...
bool RotateSense1Init (void)
{
  ...
  PORT_SetPinMux(ROTATE_SENSE1_PORT, ROTATE_SENSE1_GPIO_PIN, kPORT_MuxAsGpio);
...
DisableInterrupt();
PORT_SetPinMux(ROTATE_SENSE1_PORT, ROTATE_SENSE1_GPIO_PIN, kPORT_PinDisabledOrAnalog);
}