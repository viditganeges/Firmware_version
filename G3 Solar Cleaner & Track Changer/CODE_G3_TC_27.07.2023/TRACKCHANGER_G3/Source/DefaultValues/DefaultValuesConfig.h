...
#define HARDWARE_VERSION                                   HVER_1_1            //should be changed according to HARDWARE_VERSION


#define DEVICE_FIRMWARE_VERSION                            "FV:3.0.5"        //"D1.1.6V" RT old            //  D1.1.2V old                

#define DEFAULT_DEV_ID                                     "FFFFF"
#define DEFAULT_DEV_HW_REV                                 "HV:3.0 "       //  "HV0.1 "                                 //"1.1V"   
#define DEFAULT_DEV_SW_REV                                 DEVICE_FIRMWARE_VERSION
#define DEFAULT_DEV_SERIAL_NO                              "TC000"

#define DEFAULT_DEVICE_WELCOME_MSG_HEADER                  "TRACK CHANGER "
#define DEFAULT_DEVICE_WELCOME_MSG_FOOTER                  " **"
  
#define DEFAULT_DEVICE_WELCOME_MSG                         DEFAULT_DEVICE_WELCOME_MSG_HEADER DEFAULT_DEV_HW_REV DEFAULT_DEV_SW_REV //DEFAULT_DEVICE_WELCOME_MSG_FOOTER
